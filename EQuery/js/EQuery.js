...
EQuery.prototype.toggle=function ()
{
	var i=0;
...
EQuery.prototype.eq=function (n)
{
...
EQuery.prototype.find=function (str)
{
	var i=0;
	var aResult=[];
...
EQuery.prototype.bind=function (sEv, fn)
{
	var i=0;
...
EQuery.prototype.extend=function (name, fn)
{
	EQuery.prototype[name]=fn;
};

function $(eArg)
{
	return new EQuery(eArg);
}
